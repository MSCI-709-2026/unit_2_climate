...
```{r}
# temp_anomaly = read.table("data/global_temp_data_1880-2025.txt", skip=5, sep="", header = FALSE, col.names = c("Year", "No_Smoothing", "Lowess_5"))
...
plot(No_Smoothing ~ Year, data=temp_anomaly, ylab="Global mean temperature anomaly (*C)") + #as points
...
plot(No_Smoothing ~ Year, data=temp_anomaly, ylab="Global mean temperature anomaly") + 
  lines(No_Smoothing ~ Year, data=temp_anomaly) +
  lines(avg_5_yr ~ Year, data=temp_anomaly, col="green") 
```
...
Do you see the advantage of this? Once your rolling average user defined function has been written, you can repeat this type of calculation on any of your diverse datasets with a single, easy-to-understand (`calc_rolling_average()`) line of code.
